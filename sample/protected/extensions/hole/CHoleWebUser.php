 ...
 * @since 1.0
 */
class CHoleWebUser extends CApplicationComponent implements IWebUser
{
	...
	public function getIsGuest()
	{
		...
		{
			//echo "Zend_Auth is Set. <br>";
			$zend = $_SESSION['Zend_Auth']['storage'];
			//print_r($zend->username);
			//die;
			return false;
		}
