...
?>
		<h2><a href="<?php echo Yii::app()->baseUrl;?>/pages/<?php echo $tmpGuid;?>"><?php echo $row['fixedTitle'];?></a></h2>
		<div class="date">February 12, 2010, <a href="<?php echo Yii::app()->baseUrl;?>/hole/default/info/guid/$tmpGuid;?>" rel="facebox"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/quickview_icon.gif"> Quick View</a></div>
