...
class KutuCatalogTest extends CActiveRecord
{
	/**
	 * The followings are the available columns in table 'KutuCatalogTest':
	 * @var string $guid
	...
	public function rules()
	{
		...
		return array(
			...
			array('publishedDate, expiredDate, createdDate, modifiedDate, deletedDate, lastIndexedDate, title, subTitle, description, content', 'safe'),
		);
	}
