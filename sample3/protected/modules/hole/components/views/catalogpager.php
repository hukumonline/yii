...
<?php } ?>
	...
	?>
		...
		<?php } else { ?>
			<div class="boxItem">
		<?php }?>
			<div class="date"><?php echo $catalog['publishedDate'];?>, &nbsp;<a href="<?echo Yii::app()->baseUrl;?>/hole/default/info/guid/<?=$tmpGuid;?>" rel="facebox"><img src="<?echo Yii::app()->theme->baseUrl;?>/images/quickview_icon.gif"> Quick View</a></div>
