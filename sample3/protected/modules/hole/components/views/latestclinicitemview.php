...
?>
		...
		<div class="date">February 12, 2010, <?php echo $row['fixedSelect'];?> <a href="<?echo Yii::app()->baseUrl;?>/hole/default/info/guid/<?=$tmpGuid;?>" rel="facebox"><img src="<?echo Yii::app()->theme->baseUrl;?>/images/quickview_icon.gif"> Quick View</a></div>
