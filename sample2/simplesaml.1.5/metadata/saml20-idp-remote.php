...
$metadata['http://idp.localhost'] = array(
    'SingleSignOnService'  => 'http://idp.localhost/saml2/idp/SSOService.php',
    'SingleLogoutService'  => 'https://idp.localhost/saml2/idp/SingleLogoutService.php',
    //'certFingerprint' => 'afe71c28ef740bc87425be13a2263d37971da1f9',
	'NameIDFormat' => 'urn:oasis:names:tc:SAML:2.0:nameid-format:transient',
);
$metadata['http://idp.localhost/saml2/idp/metadata.php'] = array (
  'SingleSignOnService' => 'http://idp.localhost/saml2/idp/SSOService.php',
  //'SingleLogoutService' => 'http://idp.localhost/saml2/idp/SingleLogoutService.php',
  'certFingerprint' => 'afe71c28ef740bc87425be13a2263d37971da1f9',
  'NameIDFormat' => 'urn:oasis:names:tc:SAML:2.0:nameid-format:transient',
	'SingleLogoutService'          => 'http://idp.localhost/saml2/idp/SingleLogoutServiceiFrame.php',
	'SingleLogoutServiceResponse'  => 'http://idp.localhost/saml2/idp/SingleLogoutServiceiFrameResponse.php',
);
